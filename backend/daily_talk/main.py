...
# ── 环境变量 ──
COZE_STREAM_RUN_URL = os.getenv("COZE_STREAM_RUN_URL", "https://your-daily-talk.coze.site/stream_run")
COZE_TOKEN = os.getenv("COZE_TOKEN", "")
COZE_PROJECT_ID = os.getenv("COZE_PROJECT_ID", "REPLACE_WITH_DAILY_TALK_PROJECT_ID")
...
app = FastAPI(title="Daily Talk Backend", version="0.1.0", lifespan=lifespan)
